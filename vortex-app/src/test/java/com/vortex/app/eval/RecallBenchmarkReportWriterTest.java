...
class RecallBenchmarkReportWriterTest {
    ...
    void writeShouldIncludeSummaryResultsDiagnosticsAndMetricsByK(@org.junit.jupiter.api.io.TempDir Path tempDir)
        ...
        assertThat(markdown).contains("keyword-lift-001 | Hybrid+Rerank | HYBRID | true | true");
        assertThat(markdown).contains("keyword-lift-001 | Hybrid+Rerank | true |  | 2 | 2 | 1 | 2 | 2 | 2 | 1 | 1");
